...
function Navbar({ onLogin, loggedIn, showLogin, onProfileClick, showProfile, onCartClick, showCart }) {
  ...
  return (
    <nav className="navbar navbar-expand-lg navbar-light bg-light">
      ...
      <div className="nav-links">
        ...
        {window.innerWidth < 420 && (
          <>
          <button className="nav-btn dropdown-btn" onClick={handleDropdownClick}>
            <div className="box">
